    ...
    <div class="container">
        ...
        <div class="mt-5 row justify-content-center">
            ...
            <form class="col-md-9 col-xs-12 card card-body"
                action="{{ route('establecimiento.update', $establecimiento->id) }}" method="POST"
                ...
                <fieldset class="border p-4 mt-5">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="colonia" id="colonia"
                            class="form-control @error('colonia') is-invalid @enderror" placeholder="Colonia"
                ...
                <fieldset class="border p-4 mt-5">
                    ...
                    <div class="form-group">
                        ...
                        <input type="tel" class="form-control @error('telefono')  is-invalid  @enderror" id="telefono"
                            placeholder="Teléfono Establecimiento" name="telefono" value="{{ $establecimiento->telefono }}">
